...
define( 'HMO_VERSION',    '1.11.17' );
define( 'HMO_DB_VERSION', '1.3.6' );
...
require_once HMO_PLUGIN_DIR . 'includes/class-hmo-maps-db.php';
require_once HMO_PLUGIN_DIR . 'includes/class-hmo-maps-service.php';
...
require_once HMO_PLUGIN_DIR . 'includes/class-hmo-settings-form-handler.php';
